...
//  This Scale will be use for UIimage of exchange data
...
func kMainColor() -> UIColor {
    return kSetRGBColor(r: 107, g: 208, b: 255)
}
...
//  Gradual Change of Background Colour
...
//  Set a Notification
func setNotification(str:String) {
    ...
    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + time) {
        UIView.animate(withDuration: 0.18, delay: 0, options: .layoutSubviews, animations: {
            ...
            print("Romove Notication")
        })
    }
}


//   Set Default Width of String
